...
public class ProductRepositoryTests {
    ...
    public void testCreateProduct() {
        ...
        product.setName("Adidas Ball");
        product.setAlias("adidas_ball");
        product.setShortDescription("Short description for Adidas");
        product.setFullDescription("Full description for Adidas");

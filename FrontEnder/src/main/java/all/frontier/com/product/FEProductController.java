package all.frontier.com.product;

import all.frontier.com.category.FECategoryService;
import all.common.entity.Category;
import all.common.entity.Product;
import all.common.exception.CategoryNotFoundException;
import all.common.exception.ProductNotFoundException;
...
public class FEProductController {
    ...
    public String viewCategoryByPage(@PathVariable("category_alias") String alias,
        ...
        try {
            ...
            long startCount = (pageNum - 1) * FEProductService.PRODUCTS_PER_PAGE + 1;
            long endCount = startCount + FEProductService.PRODUCTS_PER_PAGE - 1;
    ...
    public String searchByPage(String keyword,
        ...
        long startCount = (pageNum - 1) * FEProductService.SEARCH_RESULTS_PER_PAGE + 1;
        long endCount = startCount + FEProductService.SEARCH_RESULTS_PER_PAGE - 1;
        if (endCount > pageProducts.getTotalElements()) {
            endCount = pageProducts.getTotalElements();
        }

...
import all.frontier.com.FEApplication;
import all.frontier.com.shoppingCart.CartItemRepository;
...
@Rollback(false)
@ContextConfiguration(classes = FEApplication.class)
public class CartItemRepositoryTests {
    ...
    public void testSave2Items() {
        ...
        item2.setCustomer(new Customer(11));
